...
export default function Login() {
  return (
    <div className="bg-slate-100">
      <nav className="relative w-full flex flex-wrap shadow justify-between items-center bg-indigo-500 p-3">
        <div className="flex justify-between items-center">
          <Image className="w-12 mr-10" src={nails_logo}></Image>
          <h1 className="text-2xl font-bold text-white">Редактор ногтей</h1>
        </div>
      </nav>
      <div className="flex flex-col justify-between px-28 py-16 md:flex-row ">
        <div className="flex flex-col justify-center items-center">
          ...
          <Image
            src={card_image}
            className="w-[17rem] my-10 mx-10 min-w-[17rem] rounded-xl md:min-w-[30rem] md:w-[30rem]"
          ></Image>
        </div>
        <div className="flex flex-col justify-center items-center">
          <div class=" w-72 bg-white rounded-xl flex flex-col justify-center items-center overflow-hidden shadow-lg mb-3">
          ...
          <div class="w-72 bg-white max-w-sm rounded-xl overflow-hidden shadow-lg p-3">
            <div class="flex flex-col justify-center items-center mx-4">
